[![pacseek](https://img.shields.io/static/v1?label=pacseek&message=v1.3.1-1&color=1793d1&style=for-the-badge&logo=archlinux)](https://aur.archlinux.org/packages/pacseek/)
